...
Section \ref{sssec:group_eq}. To facilitate modelling
...
trifluoride group, a uranium tetrafluoride group, a uranium flouride group 
...
CLP library \cite{lougee-heimer_common_2003}. Once the
sparse matrix representing the linear optimization problem is
constructed and packed into a dense column major format this
...
physics of the problem - but the physics of computers. As put foward in 
...
opimization problem. Furthermore, in many nuclear simulations several isotopes
...
arithmatic is incorporated ADER must be considered stochastically functional
