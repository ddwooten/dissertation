...
through which the addition of an optimization target can guarentee a unique
solution. In respect to the the ease of implementation, the ease of use, and
the comprehensabilility of the simulaiton results,
...
minimization, is a parameter which the user pases.
...
necessitating  not insignificant structural modications to ADER. A significant
